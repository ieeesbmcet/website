document.addEventListener('DOMContentLoaded', () => {
    const eventSlidesData = [
        { src: 'events/event (21).jpg', description: 'BLS' },
        { src: 'events/event (22).jpg', description: 'RISE' },
        { src: 'events/event (20).jpg', description: 'GFX Workshop' },
        { src: 'events/event (24).jpg', description: 'GPT 101' },
        { src: 'events/event (25).jpg', description: 'Empower Her' },
        { src: 'events/event (26).jpg', description: 'CommConnect' },
        { src: 'events/GitHub.png', description: 'Valorant Scrims' }
    ];
